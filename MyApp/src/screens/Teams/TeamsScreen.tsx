...
// Typage de la navigation et des routes
type RootStackParamList = {
  Teams: { newTeam?: string };
  TeamDetails: { teamName: string };
  AddTeam: undefined; // Ajout de la route AddTeam
};
        ...
        <>
          ...
          <View style={styles.separatorContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('AddTeam')} // Naviguer vers AddTeam
            >
